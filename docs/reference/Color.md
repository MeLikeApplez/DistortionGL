...
## Color.prototype.set (method)

```ts
set(r: number, g: number, b: number, a?: number): this;
```

## Color.prototype.setFromArray (method)

```ts
setFromArray(array: number[]): this;
```

## Color.prototype.setFromVector3 (method)

```ts
setFromVector3(vector: Vector3): this;
```

## Color.prototype.setFromVector4 (method)

```ts
setFromVector4(vector: Vector4): this;
```

## Color.prototype.setRgb (method)

```ts
setRgb(r: number, g: number, b: number, a?: number): this;
```

## Color.prototype.setHex (method)

```ts
setHex(hex: number, alpha?: number): this;
```

## Color.prototype.add (method)

```ts
add(color: Color): this;
```

## Color.prototype.subtract (method)

```ts
subtract(color: Color): this;
```

## Color.prototype.multiply (method)

```ts
multiply(color: Color): this;
```

## Color.prototype.divide (method)

```ts
divide(color: Color): this;
```

## Color.prototype.addScalar (method)

```ts
addScalar(factor: number): this;
```

## Color.prototype.subtractScalar (method)

```ts
subtractScalar(factor: number): this;
```

## Color.prototype.multiplyScalar (method)

```ts
multiplyScalar(factor: number): this;
```

## Color.prototype.divideScalar (method)

```ts
divideScalar(factor: number): this;
```

## Color.prototype.normalize (method)

```ts
normalize(): this;
```

## Color.prototype.floor (method)

```ts
floor(): this;
```

## Color.prototype.ceil (method)

```ts
ceil(): this;
```

## Color.prototype.round (method)

```ts
round(): this;
```

## Color.prototype.clamp (method)

```ts
clamp(min: Vector4, max: Vector4): this;
```

## Color.prototype.equals (method)

```ts
equals(color: Color): boolean;
```

## Color.prototype.lerp (method)
...
## Color.prototype.clone (method)

```ts
clone(): Color;
```

## Color.prototype.copy (method)

```ts
copy(color: Color): this;
```

# Color (exported binding)
