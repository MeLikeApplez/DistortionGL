...
## Renderer.prototype.canvasElement (HTMLCanvasElement property)

```ts
canvasElement: HTMLCanvasElement;
```

## Renderer.prototype.ready (boolean property)
...
## Renderer.prototype.setSize (method)
...
## Renderer.prototype.render (method)
...
## Vector4.prototype.x (number property)

```ts
x: number;
```

## Vector4.prototype.y (number property)

```ts
y: number;
```

## Vector4.prototype.z (number property)

```ts
z: number;
```

## Vector4.prototype.w (number property)
...
## Vector4.prototype.set (method)

```ts
set(x: number, y: number, z: number, w: number): this;
```

## Vector4.prototype.add (method)

```ts
add(vector: Vector4): this;
```

## Vector4.prototype.subtract (method)

```ts
subtract(vector: Vector4): this;
```

## Vector4.prototype.multiply (method)

```ts
multiply(vector: Vector4): this;
```

## Vector4.prototype.divide (method)

```ts
divide(vector: Vector4): this;
```

## Vector4.prototype.addScalar (method)

```ts
addScalar(factor: number): this;
```

## Vector4.prototype.subtractScalar (method)

```ts
subtractScalar(factor: number): this;
```

## Vector4.prototype.multiplyScalar (method)

```ts
multiplyScalar(factor: number): this;
```

## Vector4.prototype.divideScalar (method)

```ts
divideScalar(factor: number): this;
```

## Vector4.prototype.distanceTo (method)

```ts
distanceTo(vector: Vector4): number;
```

## Vector4.prototype.distanceToSquared (method)

```ts
distanceToSquared(vector: Vector4): number;
```

## Vector4.prototype.floor (method)

```ts
floor(): this;
```

## Vector4.prototype.ceil (method)

```ts
ceil(): this;
```

## Vector4.prototype.round (method)

```ts
round(): this;
```

## Vector4.prototype.clamp (method)

```ts
clamp(min: Vector4, max: Vector4): this;
```

## Vector4.prototype.normalize (method)

```ts
normalize(): this;
```

## Vector4.prototype.applyFromMatrix4 (method)

```ts
applyFromMatrix4(matrix: Matrix4): this;
```

## Vector4.prototype.dot (method)

```ts
dot(vector: Vector4): number;
```

## Vector4.prototype.equals (method)

```ts
equals(vector: Vector4): boolean;
```

## Vector4.prototype.toArray (method)

```ts
toArray(): number[];
```

## Vector4.prototype.fromArray (method)

```ts
fromArray(array: number[]): this;
```

## Vector4.prototype.getComponent (method)

```ts
getComponent(index: number): number;
```

## Vector4.prototype.length (method)

```ts
length(): number;
```

## Vector4.prototype.clone (method)

```ts
clone(): Vector4;
```

## Vector4.prototype.copy (method)
...
## EntityOptions.name (string property)

```ts
name?: string;
```

## EntityOptions.type (string property)
...
## Entity.prototype.uuid (string property)

```ts
readonly uuid: string;
```

## Entity.prototype.name (string property)

```ts
readonly name: string;
```

## Entity.prototype.type (string property)

```ts
readonly type: string;
```

## Entity.prototype.position (property)

```ts
position: Vector2 | Vector3 | Vector4 | null;
```

## Entity.prototype.scale (property)

```ts
scale: Vector2 | Vector3 | Vector4 | null;
```

## Entity.prototype.rotation (property)

```ts
rotation: Euler | null;
```

## Entity.prototype.quaternion (property)

```ts
quaternion: Quaternion | null;
```

## Entity.prototype.matrix (property)

```ts
matrix: Matrix3 | Matrix4 | null;
```

## Entity.prototype.visible (boolean property)

```ts
visible: boolean;
```

## Entity.prototype.loaded (boolean property)
...
## Entity.prototype.dispose (method)

- `@description` _Destroys_ — any data/buffers for clean up .

```ts
abstract dispose(renderer: TRenderer, ...any: any): void;
```

## Entity.prototype.load (method)

- `@description` _Initializes_ — entity data. Use it once to setup the entity.

```ts
abstract load(renderer: TRenderer, ...any: any): void;
```

## Entity.prototype.update (method)

- `@description` _Updates_ — entity data. Use for scene updates only.

```ts
abstract update(renderer: TRenderer, ...any: any): void;
```

## Entity.prototype.render (method)

- `@description` _Renders_ — the entity. Use for scene renders.
...
## Scene.prototype.entities (`Entity[]` property)

```ts
entities: Entity[];
```

## Scene.prototype.enabled (boolean property)

```ts
enabled: boolean;
```

## Scene.prototype.loaded (boolean property)

```ts
loaded: boolean;
```

## Scene.prototype.ready (boolean property)
...
## Scene.prototype.dispose (method)

- `@description` _Iterates_ — and destroys all entities

```ts
abstract dispose(renderer: TRenderer, camera: TCamera, ...any: any): void;
```

## Scene.prototype.load (method)

- `@description` _Initializes_ — scene and entity data. Use it once to setup the scene.

```ts
abstract load(renderer: TRenderer, camera: TCamera, ...any: any): void;
```

## Scene.prototype.render (method)

- `@description` _Renders_ — entities per frame
...
# Canvas2DRendererOptions (interface)
...
declare class Canvas2DRenderer extends Renderer {
  ...
  constructor(
    canvasElement: HTMLCanvasElement,
    ctxOptions?: Canvas2DRendererOptions,
  );
  render(scene: Scene, camera: AvailableCameras): void;
}
```

## Canvas2DRenderer.prototype.ctx (CanvasRenderingContext2D property)

```ts
ctx: CanvasRenderingContext2D;
```

## Canvas2DRenderer (constructor)

```ts
constructor(canvasElement: HTMLCanvasElement, ctxOptions?: Canvas2DRendererOptions);
```

## Canvas2DRenderer.prototype.render (method)

```ts
render(scene: Scene, camera: AvailableCameras): void;
```

# Canvas2DRenderer (exported binding)
